...
Verified 2026-09-22 against current institutional websites and brand guidance, except the Future Laboratory logo supplied directly by the site owner. These assets identify institutions in existing CV entries, not endorsements. Official artwork colors and proportions are preserved. Circular seals have excess surrounding whitespace removed and are fitted to 256px white canvases; horizontal wordmarks are kept as vectors. All use `object-fit: contain`.
...
| `tsinghua-future-lab.png` | Original PNG supplied by the site owner on 2026-09-22 for Future Laboratory. Retained unchanged, including its gray artwork and white background. Used once for the combined MindTrace / BrickSmart research entry; Tsinghua University Library keeps the university seal. |
